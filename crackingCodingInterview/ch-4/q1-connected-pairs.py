...
Node.add_neighbour(a, b)
a.add_neighbour(d)
a.add_neighbour(e)
# print(a.list_neighbours())

b.add_neighbour(a)
b.add_neighbour(c)
# print([x.name for x in b.get_neighbours()])

c.add_neighbour(b)
c.add_neighbour(d)
# print([x.name for x in c.get_neighbours()])

d.add_neighbour(a)
d.add_neighbour(c)
# print([x.name for x in d.get_neighbours()])

print(graph_connections(g))
reset_graph(g)
print("Are c and a connected? ", one_way_connected_pairs_driver(a, c))
reset_graph(g)
print("Are e and f connected? ", one_way_connected_pairs_driver(e, f))
reset_graph(g)
print("Are e and a connected? ", one_way_connected_pairs_driver(a, c))


reset_graph(g)
print("Are c and a fully connected? ", two_way_connected_pairs_driver(a, c))
